...
const canciones = [
    ...
    function nextMusic(){  
      ...
      reproduccionActual("Estás escuchando: "+ canciones[siguiente])
      classIconPlay()
    }
    ...
    function prevMusic(){  
      ...
      reproduccionActual("Estás escuchando: "+ canciones[anterior])
      classIconPlay()
    }
    ...
    function loadMusic(ruta){
      ...
      item.classList.add("active");
      reproduccionActual("Estás escuchando: "+ ruta)
      player.load()
    }
